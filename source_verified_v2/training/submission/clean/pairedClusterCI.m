...
assert(isstring(a.source_id) && isstring(b.source_id) && all(~ismissing(a.source_id)) && all(~ismissing(b.source_id)),'ICNN:IdentityType','Source identifiers must be nonmissing strings.');
