...
**Current manuscript: [Earth Science Informatics revision, 25 September 2026](source_verified_v2/documents/ESI_20260925/README.md). Computational results: [source_verified_v2](source_verified_v2/README.md).** This corrected package supersedes the numerical results and source assignments in every earlier dated package and release. Use its models, inputs and commands together.
...
- [Current ESI documents](source_verified_v2/documents/ESI_20260925) and [separate PNG/PDF figures](source_verified_v2/figures)
