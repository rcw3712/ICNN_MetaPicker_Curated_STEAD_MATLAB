...
for seed=42:44
    a=readtable(fullfile(runRoot,'Full3C','evaluation',"full15ch_seed"+seed+"_predictions.csv"),'TextType','string');
    b=readtable(fullfile(runRoot,'Zonly','evaluation',"full15ch_seed"+seed+"_predictions.csv"),'TextType','string');
