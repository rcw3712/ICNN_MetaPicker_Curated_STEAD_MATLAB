...
if nargin<2;sourceRoot=fullfile(packageRoot,'..','inputs');end
if nargin<3;runRoot=fullfile(packageRoot,'results_clean','submission40_reproduction');end
...
cfg.cleanProtocol='source_disjoint_v1';
