% Configuration retained from the completed 40-fit experiment.
% fitClean uses four TCN blocks and four I-CNN blocks; see docs/METHODS.md.
% Arrival times come from waveform CSVs. The runner overrides input paths.
% The runner also disables silent filtering of missing waveform files.
function config = config_ICNN_MetaPicker()

config.version       = '1.0.1';
config.targetJournal  = 'Computers & Geosciences';
config.frameworkName  = 'Source-grouped I-CNN evaluation workflow (curated STEAD CSV)';
