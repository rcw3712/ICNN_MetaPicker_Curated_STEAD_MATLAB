...
import numpy as np
w=Path(__file__).parent; out=w/'recomputed';out.mkdir(exist_ok=True)
r=w/'results';old=w/'original_base42'
...
def h(p):
 ...
 return hashcache[p]
# Original external-input manifests were verified locally; see audit.json.
ref=None
